...
class _HorizontalSafeArea extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext _context) =>
      _horizontalSafeArea(_context, sliver: sliver, padding: padding);
}
...
class _Category extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext _context) => _category(_context, category);
}
...
class _SectionTitle extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext _context) => _sectionTitle(_context, text);
}
...
class _ActionButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext _context) =>
      _actionButton(_context, icon: icon, label: label, onPressed: onPressed);
}
...
class _ErrorCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext _context) => _errorCard(_context, error: error);
}
...
class _InfoTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext _context) =>
      _infoTile(_context, title: title, trailing: trailing, onTap: onTap);
}
